...
} from '../../../src/shells/uxp/uxp-panel-runtime';
import type { PluginHostShell } from '../../../src/shells/uxp/create-plugin-host-shell';
...
vi.mock('../../../src/harness/components/uxp-css-contract', () => ({
  UxpCssContractHarnessPage: () => null,
}));

vi.mock('../../../src/harness/components/composer-select', () => ({
...
function fakeHost(dispose = vi.fn()): PluginHostShell {
  return {
    ...
    services: {
      ...
      promptSettings: {} as PluginHostShell['services']['promptSettings'],
