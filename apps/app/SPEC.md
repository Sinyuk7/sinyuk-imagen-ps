...
- 状态：当前阶段规范
- 依据：根级 `AGENTS.md`、`../../docs/loops/application-session-refactor-loop.md`、`STATUS.md`、`INTEGRATION_DESIGN.md`
...
- Provider profile 和 secret 持久化通过 `ProviderProfileRepository` / `SecretStorageAdapter` 注入 application/session 层。
...
- History 只展示当前 React session 内 conversation rounds。
