...
const EN_MESSAGES: AppMessages = {
  ...
  settings: {
    ...
    endpointMeasurementUnsupported: 'Speed test unavailable for this provider.',
    ...
    modelCustomUnchecked: 'Custom model not verified',
...
const ZH_CN_MESSAGES: AppMessages = {
  ...
  settings: {
    ...
    speedTest: '测速',
    testingSpeed: '测速中…',
    endpointMeasurementUnsupported: '当前 Provider 不支持测速。',
    ...
    modelCustomUnchecked: '自定义模型尚未验证',
    ...
    modelDiscoveryUnsupported: '当前 API 格式不支持模型发现。',
    apiProfile: 'API 配置',
    apiFormat: 'API 格式',
    apiFormatAuto: '自动检测',
