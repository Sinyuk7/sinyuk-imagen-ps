...
.cmp-select-menu{
  ...
  min-width:0; max-width:calc(100vw - 24px); background:var(--app-color-background-elevated); border:1px solid var(--app-color-border-strong); border-radius:var(--app-radius-medium);
  overflow:auto; scrollbar-width:thin; scrollbar-color:var(--app-color-border-default) transparent;
}
...
.cmp-chip{
  ...
  margin-top:0; margin-right:0; margin-bottom:0; margin-left:0;
  padding:2px 7px; border-radius:var(--app-radius-pill);
...
.cmp-dot{ width:5px; height:5px; margin-right:4px; border-radius:50%; background:var(--app-color-accent-default); }
.cmp-chip-body{
  display:flex;
  align-items:center;
  min-width:0;
