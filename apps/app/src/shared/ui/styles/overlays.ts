...
.ui-toast[data-variant="positive"]{ border-color:var(--app-color-border-default); background:var(--app-color-background-elevated); }
.ui-toast[data-variant="negative"]{ border-color:var(--app-color-negative); background:var(--app-color-background-elevated); }
.ui-toast[data-variant="warning"]{ border-color:var(--app-color-notice); background:var(--app-color-background-elevated); }
.ui-toast[data-variant="info"]{ border-color:var(--app-color-border-default); background:var(--app-color-background-elevated); }
.ui-toast[data-variant="neutral"]{ border-color:var(--app-color-border-default); background:var(--app-color-background-elevated); }
...
.ui-toast-icon{
  ...
  width:18px; min-width:18px; min-height:19px; margin-top:1px; margin-right:10px; color:var(--app-color-text-secondary);
}
.ui-toast[data-variant="positive"] .ui-toast-icon{ color:var(--app-color-text-secondary); }
...
.ui-toast[data-variant="info"] .ui-toast-icon{ color:var(--app-color-text-secondary); }
.ui-toast-message{
...
.ui-toast-close{
  ...
  border:none; border-radius:7px; background:transparent; color:var(--app-color-text-secondary);
