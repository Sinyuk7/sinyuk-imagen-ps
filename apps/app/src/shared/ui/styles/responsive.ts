...
.panel[data-panel-width-mode="compact"] .cmp-balance-pill{ max-width:132px; padding:0 8px; }
.panel[data-panel-width-mode="compact"] .cmp-balance-pill-label{ margin-right:4px; }
.panel[data-panel-width-mode="compact"] .cmp-balance-pill-label{ font-size:8px; }
.panel[data-panel-width-mode="compact"] .cmp-balance-pill-value{ font-size:9px; }
