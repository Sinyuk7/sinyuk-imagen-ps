...
Define cross-package compatibility verification requirements for builtin workflows, ensuring workflow contracts remain consistent with runtime assembly, provider dispatch bridge, and real provider adapters.
