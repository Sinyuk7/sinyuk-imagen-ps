...
export const GEMINI_3_1_FLASH_IMAGE_RATIOS = [
  '1:1',
  '1:4',
  '1:8',
  '2:3',
...
export const GEMINI_3_1_FLASH_IMAGE_SIZES = ['512', '1k', '2k', '4k'] as const satisfies readonly ImageSizePreset[];

export const GEMINI_3_1_FLASH_IMAGE_OUTPUT_CAPABILITY = Object.freeze({
  geometry: {
    kind: 'ratio-resolution',
    defaultGeometry: { kind: 'provider-default' },
    aspectRatios: GEMINI_3_1_FLASH_IMAGE_RATIOS,
    resolutions: GEMINI_3_1_FLASH_IMAGE_SIZES,
  },
...
export const GEMINI_3_1_FLASH_IMAGE_OUTPUT_EXPOSURE = Object.freeze({
  kind: 'ratio-resolution',
  aspectRatios: GEMINI_3_1_FLASH_IMAGE_RATIOS,
  resolutions: GEMINI_3_1_FLASH_IMAGE_SIZES,
  outputFormats: GEMINI_GENERATE_CONTENT_OUTPUT_FORMATS,
...
export function gemini31FlashImageMatrix(operation: ImageOperation): ImageOutputMatrix {
  return geminiGenerateContentImageConfigMatrix({
    operation,
    sizes: GEMINI_3_1_FLASH_IMAGE_SIZES,
