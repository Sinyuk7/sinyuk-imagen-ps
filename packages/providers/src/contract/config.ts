...
export interface ImageEndpointProviderConfig {
  ...
  /** Images endpoint relay / proxy / gateway 的基地址。 */
...
export interface ChatImageProviderConfig {
  ...
  /** Chat-compatible relay / proxy / gateway 的基地址。 */
  readonly baseURL: string;
...
export type ProviderConfig = ImageEndpointProviderConfig | ChatImageProviderConfig;
